      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative">
        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            >
              Find Your Perfect <span className="text-primary">Coding Notes</span>
            </motion.h1>
            <motion.p
              ...
              animate="visible"
            >
            Effortlessly share and access notes with our app, designed for students and educators. It's free, secure, and helps streamline your study experience.
            </motion.p>
            {/* button section */}
            <motion.div
